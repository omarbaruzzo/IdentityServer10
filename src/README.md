...
[HigginsSoft.IdentityServer8 and Admin UI NuGet packages](https://www.nuget.org/packages?q=HigginsSoft.IdentityServer8) are available here for use in .NET 8.
