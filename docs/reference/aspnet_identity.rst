...
The repo for this support is located `here <https://github.com/omarbaruzzo/IdentityServer8.AspNetIdentity/>`_ and the NuGet package is `here <https://www.nuget.org/packages/HigginsSoft.IdentityServer8.AspNetIdentity>`_.
